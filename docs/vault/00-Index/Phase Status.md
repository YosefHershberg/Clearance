...
> [!info] Current
> **Phase 1b — Client auth UI** · status **in-progress** · branch `feat/buildcheck-phase-1b` · [[../../superpowers/specs/2026-04-20-buildcheck-phase-1b-client-auth-design|design spec]]
...
| 1b | Auth UI (client) | **in-progress** | `feat/buildcheck-phase-1b` | — | login page, auth state hook, protected route wrapper, admin users page; design: [2026-04-20-buildcheck-phase-1b-client-auth-design.md](../../superpowers/specs/2026-04-20-buildcheck-phase-1b-client-auth-design.md) |
