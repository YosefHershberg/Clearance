...
> [!info] Current
> **Phase 2 — Projects + storage** · status **in-review** · branch `feat/buildcheck-phase-2` (stacked on phase-1b) · [Clearance-server#3](https://github.com/YosefHershberg/Clearance-server/pull/3) + [Clearance-client#2](https://github.com/YosefHershberg/Clearance-client/pull/2) · [[../../superpowers/specs/2026-04-20-buildcheck-phase-2-projects-storage-design|design spec]]
>
